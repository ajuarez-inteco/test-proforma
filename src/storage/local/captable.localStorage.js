import { captable } from '../../utils/constants';

function getData() {
  const data = JSON.parse(localStorage.getItem(captable));
  return data || {};
}

function setData(data) {
  localStorage.setItem(captable, JSON.stringify(data));
}
...
export const captableLocalStorage = {
  getAll,
  getById,
  create,
  update,
